...
import createBlog from '../service/BlogService'; // Ensure the path is correct
import { Editor } from '@tinymce/tinymce-react';

const MBlog = ({ isOpen, onClose, onSave }) => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            const createdBlog = await createBlog(titulo, contenido, imagen, usuario.id);
            onSave(createdBlog);
        ...
        <>
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-50">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-[1200px] pt-6">
                        <h2 className="text-3xl font-bold mb-6">Escriba su nuevo blog: </h2>
                        <hr className="my-6" />
                        <div className="flex gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <Editor
                                    apiKey="6k5kklgn1xd46rltgtcikuelrv69xzqi0urkisxn2t3s48km"
                                    value={contenido}
                                    init={{
                                        height: 300,
                                        menubar: false,
            ...
            {showSuccessMessage && (
                ...
                >
                    ...
                    <span className="block sm:inline"> El blog se ha guardado correctamente.</span>
            ...
            {showErrorMessage && (
                ...
                >
                    ...
                    <span className="block sm:inline"> Hubo un problema al guardar el blog.</span>
